    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        if (GestCookie.hasItem("employeeRole") && GestCookie.getItem("employeeRole")=="chief") {
          ...
          $.ajax({
            url: 'https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=getEmployeeFromStore',
            type: 'GET',
            dataType: 'json',
            data: {
              store_id: storeId,
          ...
          $.ajax({
            url: 'https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=getEmployeeFromAll',
            type: 'GET',
            dataType: 'json',
            success: function(data) {
              var table = $('#employeeList');
    ...
    <div class="mx-5 container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto">
          ...
          <li>
            <?php
              if($_COOKIE["employeeRole"]=="chief" || $_COOKIE["employeeRole"]=="it") {
                echo '<li class="nav-item dropdown mx-2">
                <a class="nav-link dropdown-toggle nav-hover" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                 My store
                </a>
