...
<head>
    ...
    let GestCookie = {
      ...
      function editProduct() {
        ...
        $.ajax({
          url: "https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=editProduct&auth_key=e8f1997c763",
          method: "PUT",
          data: JSON.stringify({
      ...
      function editBrand() {
        ...
        $.ajax({
          url: "https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=editBrand&auth_key=e8f1997c763",
          method: "PUT",
      ...
      function editCategory() {
        ...
        $.ajax({
          url: "https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=editCategory&auth_key=e8f1997c763",
          method: "PUT",
          data: JSON.stringify({
            category_id: categoryId,
      ...
      function editStore() {
        ...
        $.ajax({
          url: "https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=editStore&auth_key=e8f1997c763",
          method: "PUT",
          data: JSON.stringify({
            store_id: storeId,
      ...
      function editStock() {
        ...
        $.ajax({
          url: "https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=editStock&auth_key=e8f1997c763",
          method: "PUT",
          data: JSON.stringify({
            stock_id: stockId,
            store_id: storeId,
