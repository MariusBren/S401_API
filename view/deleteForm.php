...
<head>
    ...
    let GestCookie = {
      ...
      function fillStocks() {
        ...
        $(document).ready(function(){
          $.ajax({
            url: 'https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=getStocksFromStore&store_id='+storeId,
            type: 'GET',
            dataType: 'json',
      ...
      function deleteProduct() {
        ...
        $.ajax({
          url: "https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=deleteProduct&auth_key=e8f1997c763",
          method: "DELETE",
          data: JSON.stringify({
      ...
      function deleteBrand() {
        ...
        $.ajax({
          url: "https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=deleteBrand&auth_key=e8f1997c763",
          method: "DELETE",
          data: JSON.stringify({
            brand_id: brandId,
          }),
      ...
      function deleteCategory() {
        ...
        $.ajax({
          url: "https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=deleteCategory&auth_key=e8f1997c763",
          method: "DELETE",
          data: JSON.stringify({
      ...
      function deleteStore() {
        ...
        $.ajax({
          url: "https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=deleteStore&auth_key=e8f1997c763",
          method: "DELETE",
          data: JSON.stringify({
            store_id: storeId,
          }),
      ...
      function deleteStock() {
        ...
        $.ajax({
          url: "https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=deleteStock&auth_key=e8f1997c763",
          method: "DELETE",
          data: JSON.stringify({
            stock_id: stockId,
          }),
    ...
    <div class="mx-5 container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ms-auto">
          ...
          <li>
            <?php
              if(isset($_COOKIE["employeeRole"]) && $_COOKIE["employeeRole"]=="chief" || isset($_COOKIE["employeeRole"]) && $_COOKIE["employeeRole"]=="it") {
                echo '<li class="nav-item dropdown mx-2">
                <a class="nav-link dropdown-toggle nav-hover" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                 My store
                </a>
