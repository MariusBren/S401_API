...
<head>
    ...
    <script type="text/javascript">
      ...
      $('#maxPriceFilter').val('');
            $.ajax({
                url: 'https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=getAllProducts',
                type: 'GET',
                dataType: 'json',
    ...
    $(document).ready(function(){
      ...
      function getStoresLocations() {
        $.getJSON("https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=getAddresses", {}, function(data) {
          var requests = [];
          $.each(data, function(index) {
