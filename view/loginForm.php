                  ...
                  <form>
                    ...
                    <script type="text/javascript">
                      ...
                      function loginValidate() {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php",
                            data: requestData,
                            dataType: "json",
                            success: function (response) {
                                if (response.length > 0) {
                                    ...
                                    //document.cookie = "EmployeeCookie=" + "employeeId=" + employeeId + ",employeeRole=" + employeeRole + ",employeeStore=" + employeeStore + ";";
                                    document.cookie = "employeeId=" + employeeId + "; path=/";
                                    document.cookie = "employeeRole=" + employeeRole + "; path=/";
                                    document.cookie = "employeeStore=" + employeeStore + "; path=/";
