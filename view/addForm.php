...
<head>
    ...
    let GestCookie = {
      ...
      function addProduct() {
        ...
        $.ajax({
          url: "https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=addProduct",
          method: "POST",
          data: {
      ...
      function addBrand() {
        ...
        $.ajax({
          url: "https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=addBrand",
          method: "POST",
          data: {
      ...
      function addCategory() {
        ...
        $.ajax({
          url: "https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=addCategory",
          method: "POST",
          data: {
      ...
      function addStore() {
        ...
        $.ajax({
          url: "https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=addStore",
          method: "POST",
          data: {
      ...
      function addStock() {
        ...
        $.ajax({
          url: "https://dev-brennet222.users.info.unicaen.fr/DEV_S4/SAE401/scripts/bikestores.php?action=addStock",
          method: "POST",
          data: {
            store_id: storeId,
